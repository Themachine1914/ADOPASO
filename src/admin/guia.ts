  ...
  },
  {
    ...
    articulos: [
      ...
      },
      {
        ...
        nota: 'Al guardar, el sistema arma solo los abuelos y bisabuelos a partir del registro de los padres, y agrega el caballo a la descendencia de cada antepasado. Al corregir un caballo antiguo, padre y madre no se exigen si el libro no trae su código.',
        enlace: { to: '/admin/caballos', label: 'Abrir Registro de caballos' },
      },
      {
      ...
      },
      {
        ...
        nota: 'Las asociaciones aparecen en el buscador «Asociación» al registrar un caballo. También puede crear una desde ahí, con «Agregar nuevo».',
  ...
  },
  {
    ...
    articulos: [
      ...
      },
      {
        ...
        nota: 'Al registrar un caballo, el propietario se elige entre los socios y el criador entre los criadores. Si no existen, se crean con «Agregar nuevo».',
      },
      {
